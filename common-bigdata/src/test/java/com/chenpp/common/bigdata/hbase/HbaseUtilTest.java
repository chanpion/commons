...
public class HbaseUtilTest {
    ...
    public void init() throws IOException {
        ...
        hbaseConf.setHbaseHost("yuntu-d-010057036018.te.td,yuntu-d-010057036019.te.td,yuntu-d-010057036017.te.td");
...
//        System.setProperty("java.security.krb5.kdc", "");
        ...
        kerberosHBaseConf.setHbaseHost("yuntu-qiye-e-010058012062.hz.td,yuntu-qiye-e-010058012060.hz.td,yuntu-qiye-e-010058012061.hz.td");
        kerberosHBaseConf.setHbasePort("2181");
        kerberosHBaseConf.setHbaseZnode("/hbase-secure");
        kerberosHBaseConf.setKerberosEnable(true);
        kerberosHBaseConf.setMasterPrincipal("hbase/_HOST@yuntu.comm");
        kerberosHBaseConf.setRegionServerPrincipal("hbase/_HOST@yuntu.comm");
    ...
    public void connect() throws IOException {
        ...
        config.set("hbase.zookeeper.quorum", "yuntu-d-010057036018.te.td,yuntu-d-010057036019.te.td,yuntu-d-010057036017.te.td");
        //检查配置
    ...
    public void testGetOneRow() throws Exception {
        HbaseRow data = HBaseUtil.getOneRow(hbaseConf, "zctest_indicator_entity", "107group1");
