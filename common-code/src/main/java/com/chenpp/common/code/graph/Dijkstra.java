...
/**
 * {@link <a href="https://mp.weixin.qq.com/s/gjjrsj95X4w7QdWBlAKnaA"/>}
 *
 * @author April.Chen
 * @date 2024/4/19 13:37
 */
public class Dijkstra {
    ...
    public static Map<Integer, Integer> dijkstra(Graph graph, int startIndex) {
        ...
        Map<Integer, Integer> distanceMap = new HashMap<>(graph.vertexes.length);
