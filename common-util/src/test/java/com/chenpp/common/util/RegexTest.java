...
public class RegexTest {
    ...
    public void matchRegex(String text, String regex) {
    ...
    public void testRegex() {
        ...
        String pattern = "(\\D*)(\\d+)(.*)";
//        matchRegex(line, pattern);
//        matchRegex("xyz-001测试123", "[A-Za-z0-9\\-]+");

        matchRegex("xyz-001[测试]x[123]", "\\[(.*?)]");
        matchRegex("xyz-001[测试]x[123]", "(\\[(.*?)])");
        matchRegex("xyz-001[测试]x[123]", "[\\w-]+");

        System.out.println("xyz-001[测试]x[123]【中文】".replaceFirst("\\[(.*?)]", " $1 "));
        System.out.println("xyz-001[测试]x[123]【中文】".replaceFirst("【(.*?)】", " $1 "));
    ...
    public void testMatchAndReplace() {
        String text = "xyz-001[测试]x[123]【中文】";
        String regex = "\\[(.*?)]";
        Pattern pattern = Pattern.compile(regex);
        Matcher matcher = pattern.matcher(text);
        while (matcher.find()) {
